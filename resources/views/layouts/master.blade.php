...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon"
          href="{{ URL::asset('assets/img/apple-touch-icon-57x57-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72"
          href="{{ URL::asset('assets/img/apple-touch-icon-72x72-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114"
          href="{{ URL::asset('assets/img/apple-touch-icon-114x114-precomposed.png') }}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144"
          href="{{ URL::asset('assets/img/apple-touch-icon-144x144-precomposed.png') }}">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="collapse dont-collapse-sm contacts" id="collapse_3">
                    <ul>
                        <li><i class="ti-home"></i>Bách Khoa<br>Hà Nội - Việt Nam</li>
                        <li><i class="ti-mobile"></i>+84 123-456-789</li>
                        <li><i class="ti-email"></i><a href="#0">wanderlust_frag@gmail.com</a></li>
        ...
        <div class="row add_bottom_25">
            ...
            <div class="col-lg-6">
                <ul class="additional_links">
                    ...
                    <li><span>© 2023 Wanderlust</span></li>
                </ul>
            </div>
        </div>
    </div>
