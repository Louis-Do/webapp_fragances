                    ...
                    <div class="owl-stage">
                        <div class="owl-item active center">
                            <div class="item">
                                <a href="#0">
                                    <div class="title">
                                        <h4>Đỗ Quốc Thái<em>CEO</em></h4>
                                    </div>
                                    <img
                                        src="https://res.cloudinary.com/vernom/image/upload/v1705143769/perfume_project/about/Screenshot_2024-01-13_at_17.58.48_tc4ue9.png"
                                        alt="">
                                </a>
                            </div>
                        </div>
                        <div class="owl-item active">
                            <div class="item">
                                <a href="#0">
                                    <div class="title">
                                        <h4>Lebron James<em>Marketing</em></h4>
                                    </div>
                                    <img
                                        src="https://res.cloudinary.com/vernom/image/upload/v1705143730/perfume_project/about/LeBron_James__51959977144___cropped2_nuewzh.jpg"
                                        alt="">
                                </a>
                            </div>
                        </div>
                        <div class="owl-item active">
                            <div class="item">
                                <a href="#0">
                                    <div class="title">
                                        <h4>Elon Musk<em>Business strategist</em></h4>
                                    </div>
                                    <img
                                        src="https://res.cloudinary.com/vernom/image/upload/v1705143754/perfume_project/about/elon_musk_goctnx.webp"
                                        alt="">
                                </a>
                            </div>
                        </div>
                        <div class="owl-item">
                            <div class="item">
                                <a href="#0">
                                    <div class="title">
                                        <h4>CR7<em>Customer Service</em></h4>
                                    </div>
                                    <img
                                        src="https://res.cloudinary.com/vernom/image/upload/v1705143718/perfume_project/about/cr7_vukfb4.jpg"
                                        alt="">
                                </a>
                            </div>
                        </div>
                        <div class="owl-item">
                            <div class="item">
                                <a href="#0">
                                    <div class="title">
                                        <h4>Brad Pitt<em>Admissions</em></h4>
                                    </div>
                                    <img
                                        src="https://res.cloudinary.com/vernom/image/upload/v1705143717/perfume_project/about/brad_pitt_f96onu.jpg"
                                        alt="">
                                </a>
                            </div>
                        </div>
