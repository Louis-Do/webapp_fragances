...
@section('specify_js')
    ...
    <script>
        ...
        var chart3 = new Chart(ctx, {
            ...
            // The data for our dataset
            data: {
                labels: [@foreach($origins as $origin) "{{$origin->name}}",@endforeach],
                datasets: [
                    {
                        label: "My First dataset",
                        backgroundColor: ['purple', 'orange', 'red', 'green', 'blue', 'purple', 'indigo', 'black', 'cyan'],
                        borderColor: '#fff',
                        data: [@foreach($origins as $origin) "{{count($origin->products)}}",@endforeach],
                    }]
            },
            // Configuration options go here
            options: {}
    ...
    <div class="content">
        ...
        <div class="container-fluid">
                    ...
                    <div class="card-box widget-box-two widget-two-custom">
                        <div class="media">
                            ...
                            <div class="wigdet-two-content media-body">
                                ...
                                <p class="m-0">Oct 2023 - Jan 2024</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card-box">
                        <div class="card-box" style="min-height: 90%">
                            <canvas id="myChartOrigin"></canvas>
                            <div style="text-align: center;margin-top: 5%;">Tỉ lệ sản phẩm theo xuất xứ</div>
                        </div>
                    </div>
                </div>
                                ...
                                <svg width="245.1999969482422" height="280" style="overflow: hidden;">
                                    ...
                                    <g transform="translate(0,259.984375)">
                                        <g class="c3-legend-item c3-legend-item-Done"
                                           style="visibility: visible; cursor: pointer;">
                                            <text x="59.904685974121094" y="9" style="pointer-events: none;">Success</text>
                                        ...
                                        <g class="c3-legend-item c3-legend-item-Due"
                                           style="visibility: visible; cursor: pointer;">
                                            <text x="118.5921859741211" y="9" style="pointer-events: none;">Waiting</text>
                                        ...
                                        <g class="c3-legend-item c3-legend-item-Hold"
                                           style="visibility: visible; cursor: pointer;">
                                            <text x="169.4984359741211" y="9" style="pointer-events: none;">Cancelled</text>
