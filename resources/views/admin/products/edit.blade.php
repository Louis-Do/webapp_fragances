                            ...
                            <div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group" style="width: 60%">
                                            <label for="userName"> Tuổi khuyên dùng<span
                                                        class="text-danger">*</span></label>
                                            <input type="text" name="recommended_age" parsley-trigger="change"
                                                   required=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumbnails" style="display: flex">
                                        <ul class="cloudinary-thumbnails" style="list-style-type: none;">
                                            @foreach($product->ThumbnailArray as $thumb)
                                                    <li class="cloudinary-thumbnail active" data-cloudinary="" style="display:block; float: left; width: 33%; ">
                                                        <img src="{{$thumb}}" style="width: 150px;height: 150px">
                                                        <a href="#" class="cloudinary-delete">Remove</a>
                                                    </li>
                                            @endforeach
